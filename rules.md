...
- `DEX` + `DEX`: _Agility_, _Slight of hand_
...
A successful _Medicine_ test of **difficulty** `10` will **stabilise** a character, but true recovery can require days, or perhaps specialised equipment (at the discretion of the GM).
...
In addition to the equipment provided by role's, players may also take Normal Clothes, a Space Suit, a Short Range Communicator, a Pad, and their choice of either a Combat Knife of an Auto Pistol.
...
|:------ |:---- | -----:| --------:|
| Combat Knife | Melee | `2 metres` | `+2` |
| Improvised Weapon | Melee | `2 metres` | `+0` |
| Shock Rod | Melee | `2 metres` | `+3` |
| Assault Rifle | Ranged | `400 metres` | `+4` |
| Auto Pistol | Ranged | `50 metres` | `+2` |
